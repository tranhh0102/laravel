        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">Tranh</span>Shopper</h1>
            </a>

            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Ha Noi</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>ltanh002@gmail.com</p>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#">Tranh Shop</a>. All Rights Reserved.
                Designed
                by
                <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com">Tranh</a>
            </p>
        </div>
