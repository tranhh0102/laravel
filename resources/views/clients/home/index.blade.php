              ...
              @foreach ($product as $item)
                  <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                      <div class="card product-item border-0 mb-4">
                        ...
                        <img class="img-fluid" src="{{ asset('clients/img') }}/{{$item->image}}"
                                        alt="">
                        </div>
                            ...
                            <a href="{{route('clients.products.show',$item->id ) }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
